        ...
        Column(
                                    ...
                                    auth.signInWithEmailAndPassword(email, password)
                                        .addOnCompleteListener { task ->
                                            if (task.isSuccessful) {
                                                ...
                                                global.loggedinuser.value = name
            ...
            if (isSigningUp) {
                ...
                Row(
                    ...
                    Text(if (isSigningUp) "Already have an account? " else "Don't have an account?", style = CC.descriptionTextStyle)
                    Text(if (isSigningUp) "Sign In" else "Sign Up", style = CC.descriptionTextStyle,
