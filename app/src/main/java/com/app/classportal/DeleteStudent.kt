...
fun DeleteStudentScreen(context: Context, navController: NavController) {
    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            LazyColumn(
                modifier = Modifier.border(1.dp, GlobalColors.secondaryColor),
                horizontalAlignment = Alignment.CenterHorizontally
            ) {
                item {
                    ...
                    OutlinedTextField(value = searchQuery,
                        ...
                        placeholder = { Text("Search", style = CC.descriptionTextStyle) },
                        modifier = Modifier
                            .height(50.dp)
                            .fillMaxWidth(0.9f),
                ...
                itemsIndexed(students) { _, student ->
                    val isSelected =
                        student == selectedItem.value  // Determine if this row is selected
                    val background =
                        if (isSelected) GlobalColors.secondaryColor else Color.Transparent
                    Row(
                        modifier = Modifier
                        ...
                        Row(
                            ...
                            Text(
                                student.firstName, style = CC.descriptionTextStyle
                            )
                            Text(
                                student.lastName, style = CC.descriptionTextStyle
                            )
                        }

                        Text(
                            student.registrationID, style = CC.descriptionTextStyle
                        )
                    }
                }
            }
            Button(
                onClick = {
                    ...
                    Toast.makeText(
                        context, "Student details deleted!", Toast.LENGTH_SHORT
                    ).show()
                    selected = false
                },
                ...
                Text(
                    "Delete this student", style = CC.descriptionTextStyle
                )
            }
        }
    }
