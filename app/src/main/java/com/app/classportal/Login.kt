        ...
        Column(
            ...
            Column(
                ...
                AnimatedVisibility(visible = !isRegistering) {
                    Row(
                        ...
                        Text("Forgot Password?", style = CC.descriptionTextStyle)
                        Text(
                            " Reset",
                            modifier = Modifier
            ...
            Column(
                ...
                Column(
                    ...
                    Text(text = "$text as a $category? ", style = CC.descriptionTextStyle)
            ...
            Text("Developed by Mike", style = CC.descriptionTextStyle, fontSize = 10.sp)
        }
    }
}
