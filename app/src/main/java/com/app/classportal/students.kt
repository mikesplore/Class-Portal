        ...
        TopAppBar(
            title = {
                Row(
                    ...
                    Text("Students", style = CC.titleTextStyle, modifier = Modifier.clickable {
        ...
        Column(
            ...
            Row(
                ...
                Button(
                    ...
                    Text("Reg ID", style = CC.descriptionTextStyle)
                }
                Button(
                    onClick = {
                    ...
                    Text("First Name", style = CC.descriptionTextStyle)
                }
                Button(
                    onClick = {
                    ...
                    Text("Last Name", style = CC.descriptionTextStyle)
                }
